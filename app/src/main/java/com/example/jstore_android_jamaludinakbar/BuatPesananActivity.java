        ...
        pesan.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selected.equals("Pay Now")){
                    request = new BuatPesananRequest(String.valueOf(itemId), String.valueOf(currentUserId), "http://192.168.43.100:8085/createinvoicepaid", responseListener);
                }else if(selected.equals("Pay Later")){
                    request = new BuatPesananRequest(String.valueOf(itemId), String.valueOf(currentUserId), "http://192.168.43.100:8085/createinvoiceunpaid", responseListener);
                }else if(selected.equals("Installment")){
                    request = new BuatPesananRequest(String.valueOf(itemId), period, String.valueOf(currentUserId), "http://192.168.43.100:8085/createinvoiceinstallment", responseListener);
                }
